...
if greatWeapon = true
{
    handX[2] = round(handX[1]+lengthdir_x(2*sX, (handRot[1])))
    handY[2] = round(handY[1]+lengthdir_y(2*sX, (handRot[1])))
}
...
if abs(angle_difference(270,facing+(hFacing*handDir[2]))) > 90 and (greatWeapon = false or bodyVFacing = 1)
{
    //Draw Hand2
