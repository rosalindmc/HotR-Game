...
repeat(2)
{
    ...
    talentPrereq(branchBattleRush,treeToughness)
    ...
    talentPrereq(branchAssessSituation,treeInsight)
    talentPrereq(branchPreciseStrike,treeInsight)
    talentPrereq(branchSpotWeakness,treeInsight)
    talentPrereq(branchSap,treeInsight)
    ...
    talentPrereq(branchFightDirty,treeSubterfuge)
    talentPrereq(branchVanish,treeSubterfuge)
    talentPrereq(branchDebilitate,treeSubterfuge)
    talentPrereq(branchShadowStrike,treeSubterfuge)
    ...
    talentPrereq(branchCounterAttack,treeDiscipline)
    talentPrereq(branchHoldTheLine,treeDiscipline)
    talentPrereq(branchGuardedAttack,treeDiscipline)
